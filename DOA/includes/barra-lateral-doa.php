<aside class="barra-lateral-doa">
    ...
    <nav class="navegacion-lateral-doa" aria-label="Navegación principal de DOA">
        <?php if ($rol_pagina === "alumno") { ?>
            ...
            <a class="navegacion-lateral-doa__item <?php echo $pagina_activa === "notificaciones" ? "navegacion-lateral-doa__item--activo" : ""; ?>" href="notificaciones.php">
                <span class="navegacion-lateral-doa__icono" aria-hidden="true">
                ...
                <span class="navegacion-lateral-doa__texto">
                    Notificaciones
