...
<html lang="es">
 ...
 <body class="pagina-doa pagina-listado-tareas pagina-listado-tareas-profe">
  <!-- Header -->
  ...
  <div class="layout-doa">
   ...
   <main class="contenido-doa contenido-detalle-asignatura contenido-listado-tareas">
    ...
    <section class="detalle-asignatura-principal">
     ...
     <div class="cabecera-detalle-asignatura">
      ...
      <div class="cabecera-detalle-asignatura__pestanas">
       <nav aria-label="Secciones de la asignatura" class="pestanas-asignatura">
        <a class="pestanas-asignatura__item" href="recursosdoa.html">
         Recursos
        </a>
        <a class="pestanas-asignatura__item pestanas-asignatura__item--activo" href="listado_tareas_profe.html">
         Tareas
        </a>
        <a class="pestanas-asignatura__item" href="examenes_profesor.html">
         Exámenes
        </a>
        <a class="pestanas-asignatura__item" href="detalle_tarea_entregada.html">
         Calificaciones
        </a>
       </nav>
      </div>
     ...
     <div class="acciones-superiores-tareas">
      <button class="boton-secundario boton-crear-tarea" onclick="window.location.href='crear_tarea.html'" type="button">
       Crear tarea
      </button>
     </div>
     ...
     <section class="proxima-entrega">
      ...
      <div class="proxima-entrega__accion">
       ...
       <a class="boton-ver-detalles" href="detalle_tarea_profe.html">
        Ver detalles
       </a>
      </div>
     </section>
     ...
     <section class="bloque-listado-tareas">
      ...
      <div class="tabla-tareas">
       ...
       <article class="fila-tarea" data-estado="entregada" data-fecha-entrega="2026-04-19" data-tipo="tarea">
        <a class="fila-tarea__nombre" href="detalle_tarea_profe.html">
        ...
        <button class="boton-secundario boton-editar-tarea" onclick="window.location.href='crear_tarea.html'" type="button">
         Editar tarea
        </button>
       </article>
       <!-- Final tarea 1 -->
